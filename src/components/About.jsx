function About() {
    return (
        <div id="about">
            <h1 class="display-3">Diego Guevara</h1>
            <p class="fst-italic">science & technology</p>
            <div class="row">
                <div class="col-sm mt-2 order-sm-1 order-2">
                    <p class="justifying-text">I'm a former electromechanical engineer with a deep passion for both renewable energy and programming. I'm currently transitioning into the tech industry, eager to apply my skills as a full-stack developer.</p>
                    <p class="justifying-text">I've trained through the freeCodeCamp bootcamp, where I gained hands-on experience in both front-end and back-end development. I'm incredibly grateful to the freeCodeCamp team — their lessons empowered me to build this very website.</p>
                    <p class="justifying-text">Right now, I'm actively seeking my first opportunity in tech, where I can grow professionally, contribute to meaningful projects, and learn from experienced teammates. My long-term goal? To reach a point where I can combine my engineering background with my coding expertise to support innovative green solutions within a forward-thinking IT team.</p> 
                </div>
                <div class="col-sm-4 col mt-3 order-sm-2 order-1 m-1 p-0">
